...
include("{$dir_test}/testcase/OpeTestCase.php");
...
include("{$dir_test}/testcase/SubnameTestCase.php");
include("{$dir_test}/testcase/PluginsTestCase.php");
